...
const RenderLeader = ({leader}) => {
    return (
        <Media tag={"li"} className={"row"}>
            ...
            <Media body className="col-10 mb-4">
                    ...
                    <Card>
                        <CardBody className="bg-faded">
                            <blockquote className="blockquote">
                                <p className="mb-auto">You better cut the pizza in four pieces because
                                    I'm not hungry enough to eat six.</p>
                                <footer className="blockquote-footer mt-auto">Yogi Berra,
